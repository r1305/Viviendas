...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
                ...
                <tbody>
                    <c:forEach var="a" items="${h.rows}">
                        <tr>
                            ...
                            <td style="width: 10%">
                                <button type="button" class="btn btn-primary" onclick="location.href = 'EditarSolicitud.jsp?id=${a.numSolicitud}'">Editar</button>
                            </td>
                        </tr>
                    </c:forEach>
            ...
            <button type="button" class="btn btn-primary" onclick="location.href = 'SolicituDeCompra.jsp'">Crear Solicitud de compra</button>
